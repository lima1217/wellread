...
const migrations: Record<SchemaType, MigrationEntry[]> = {
  ...
  // Legacy Reedy agent schema (reedy_book_*, reedy_metrics, reedy_memory,
  // reedy_skills) was never opened by production code after Reading Assistant
  // moved to eve sidecar + session JSON. Do not reintroduce those tables.
};
