...
export type PathOk = { ok: true; hostPath: string; realPath: string };
...
export type RealpathLookup = (
  absoluteHostPath: string,
) => { kind: 'missing' } | { kind: 'file' | 'dir' } | { kind: 'symlink'; target: string };

export function isWorkspacePath(workspacePath: string): boolean {
 ...
 */
export function workspaceToHost(workspacePath: string, booksRoot: string): PathResult {
 ...
 */
export function realpath(absoluteHostPath: string, lookup: RealpathLookup): PathResult {
...
function underRoot(realPath: string, root: string): boolean {
...
export function authorizeWellreadSearch(
  workspacePath: string,
  booksRoot: string,
  lookup: RealpathLookup,
): PathResult {
